...
def _train(model: VAE, train_data_path: str, epoch: int):
    ...
    loggers = [TensorBoardLogger("lightning_logs", name=model.name(), default_hp_metric=False), CSVLogger(save_dir, name=None, version="")]
