...
from vae.vae import VAE, VAETrainer, sample
...
def _train(
    ...
    trainer = VAETrainer(epoch, batch_size, 100, save_path, device)
    # 训练
...
if __name__ == '__main__':
    ...
    model: VAE = torch.compile(model, fullgraph=True, disable=False) # noqa
    ...
    _train(model, "./run/datasets/anime_faces64.h5", save_path=save_path, epoch=32)
